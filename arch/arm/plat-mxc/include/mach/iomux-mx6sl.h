...
#define MX6SL_PDINT_PAD_CTRL (PAD_CTL_PKE | PAD_CTL_PUE |		\
...
#define MX6SL_PAD_AUD_MCLK__GPIO_1_6                                          \
		IOMUX_PAD(0x02A4, 0x004C, 5, 0x0000, 0, MX6SL_FLOAT_PAD_CTRL)
...
#define MX6SL_PAD_ECSPI1_MISO__GPIO_4_10_PUINT                                      \
		IOMUX_PAD(0x0358, 0x0068, 5, 0x0000, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
...
#define MX6SL_PAD_ECSPI1_MOSI__GPIO_4_9_PUINT                                       \
		IOMUX_PAD(0x035C, 0x006C, 5, 0x0000, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
...
#define MX6SL_PAD_ECSPI1_SCLK__GPIO_4_8_PUINT                                       \
		IOMUX_PAD(0x0360, 0x0070, 5, 0x0000, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
...
#define MX6SL_PAD_ECSPI2_MISO__GPIO_4_14_PUINT                                      \
		IOMUX_PAD(0x0368, 0x0078, 5, 0x0000, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
...
#define MX6SL_PAD_ECSPI2_SS0__ECSPI2_SS0                                      \
		IOMUX_PAD(0x0374, 0x0084, 0, 0x06A8, 0, MX6SL_ECSPI_PAD_CTRL)
...
#define MX6SL_PAD_ECSPI2_SS0__GPIO_4_15_PUINT                                       \
		IOMUX_PAD(0x0374, 0x0084, 5, 0x0000, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
...
#define MX6SL_PAD_EPDC_GDCLK__GPIO_1_31_KEY                                       \
		IOMUX_PAD(0x03C0, 0x00D0, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_EPDC_GDOE__GPIO_2_0_KEY                                         \
		IOMUX_PAD(0x03C4, 0x00D4, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_EPDC_GDRL__GPIO_2_1_KEY                                         \
		IOMUX_PAD(0x03C8, 0x00D8, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_EPDC_GDSP__GPIO_2_2_KEY                                         \
		IOMUX_PAD(0x03CC, 0x00DC, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_EPDC_SDCLK__GPIO_1_23_KEY                                       \
		IOMUX_PAD(0x0400, 0x0110, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_EPDC_SDSHR__GPIO_1_26_KEY                                      \
		IOMUX_PAD(0x040C, 0x011C, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)		
...
#define MX6SL_PAD_FEC_TX_CLK__GPIO_4_21                                       \
		IOMUX_PAD(0x0434, 0x0144, 5|IOMUX_CONFIG_SION, 0x0000, 0, MX6SL_FLOAT_PAD_CTRL)
...
#define MX6SL_PAD_KEY_COL0__GPIO_3_24_SION_OUT                                         \
		IOMUX_PAD(0x0474, 0x016C, 5| IOMUX_CONFIG_SION, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_KEY_COL1__GPIO_3_26_PULLHIGH                                         \
		IOMUX_PAD(0x0478, 0x0170, 5, 0x0000, 0, MX6SL_UART_PAD_CTRL)		
...
#define MX6SL_PAD_KEY_COL3__GPIO_3_30_SION_OUT                                         \
		IOMUX_PAD(0x0480, 0x0178, 5| IOMUX_CONFIG_SION, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_KEY_COL4__GPIO_4_0_SION_OUT                                          \
		IOMUX_PAD(0x0484, 0x017C, 5| IOMUX_CONFIG_SION, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_KEY_COL5__GPIO_4_2_SION_OUT                                          \
		IOMUX_PAD(0x0488, 0x0180, 5| IOMUX_CONFIG_SION, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_KEY_ROW0__GPIO_3_25                                         \
		IOMUX_PAD(0x0494, 0x018C, 5, 0x0000, 0, (PAD_CTL_HYS|PAD_CTL_PKE|PAD_CTL_DSE_40ohm))
#define MX6SL_PAD_KEY_ROW0__GPIO_3_25_SION_OUT                                         \
		IOMUX_PAD(0x0494, 0x018C, 5| IOMUX_CONFIG_SION, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_KEY_ROW1__GPIO_3_27_SION_OUT                                         \
		IOMUX_PAD(0x0498, 0x0190, 5| IOMUX_CONFIG_SION, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_KEY_ROW2__GPIO_3_29_SION_OUT                                         \
		IOMUX_PAD(0x049C, 0x0194, 5| IOMUX_CONFIG_SION, 0x0000, 0, NO_PAD_CTRL)
#define MX6SL_PAD_KEY_ROW2__GPIO_3_29_PDINT                                         \
		IOMUX_PAD(0x049C, 0x0194, 5, 0x0000, 0,MX6SL_PDINT_PAD_CTRL )
...
#define MX6SL_PAD_KEY_ROW3__GPIO_3_31_SION_OUT                                         \
		IOMUX_PAD(0x04A0, 0x0198, 5| IOMUX_CONFIG_SION, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_KEY_ROW4__GPIO_4_1_SION                                          \
...
#define MX6SL_PAD_KEY_ROW5__GPIO_4_3_PULLHIGH                                          \
		IOMUX_PAD(0x04A8, 0x01A0, 5, 0x0000, 0, MX6SL_UART_PAD_CTRL)
#define MX6SL_PAD_KEY_ROW5__GPIO_4_3_PDINT                                          \
		IOMUX_PAD(0x04A8, 0x01A0, 5, 0x0000, 0, MX6SL_PDINT_PAD_CTRL)
...
#define MX6SL_PAD_LCD_DAT0__ECSPI1_MOSI                                       \
		IOMUX_PAD(0x04B8, 0x01B0, 1, 0x0688, 1, MX6SL_ECSPI_PAD_CTRL)
...
#define MX6SL_PAD_LCD_DAT1__ECSPI1_MISO                                       \
		IOMUX_PAD(0x04BC, 0x01B4, 1, 0x0684, 1, MX6SL_ECSPI_PAD_CTRL)
...
#define MX6SL_PAD_LCD_DAT2__ECSPI1_SS0                                        \
		IOMUX_PAD(0x04E8, 0x01E0, 1, 0x068C, 1, MX6SL_ECSPI_PAD_CTRL)
...
#define MX6SL_PAD_LCD_DAT2__GPIO_2_22_SION                                         \
		IOMUX_PAD(0x04E8, 0x01E0, 5| IOMUX_CONFIG_SION, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_LCD_DAT3__ECSPI1_SCLK                                       \
		IOMUX_PAD(0x04FC, 0x01F4, 1, 0x067C, 1, MX6SL_ECSPI_PAD_CTRL)
...
#define MX6SL_PAD_SD1_DAT5__GPIO_5_9_PU                                          \
		IOMUX_PAD(0x0550, 0x0248, 5, 0x0000, 0, MX6SL_USDHC_PAD_CTRL)
...
#define MX6SL_PAD_SD1_DAT6__GPIO_5_7_KEY                                          \
		IOMUX_PAD(0x0554, 0x024C, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)		
