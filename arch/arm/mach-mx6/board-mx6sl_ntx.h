...
#define MX6SL_WACOM_PDCT_3_29		IMX_GPIO_NR(3, 29)	/* COL5 */
#else
...
#define MX6SL_WACOM_FWE_3_27	IMX_GPIO_NR(3, 27)	/* COL0 */
#define MX6SL_WACOM_RST			IMX_GPIO_NR(3, 30)	/* COL3 */
#define MX6SL_WACOM_RST_4_1		IMX_GPIO_NR(4, 1)	/* COL3 */
#define MX6SL_WACOM_INT_3_31			IMX_GPIO_NR(3,31)	/* ROW4 */
...
//#define MX6SL_AD_1V8_ON_3_25		IMX_GPIO_NR(3, 25)      /* ROW0 */
//#define MX6SL_AD_3V3_ON_3_27		IMX_GPIO_NR(3, 27)	/* ROW1 */
#define MX6SL_USB_ID			IMX_GPIO_NR(5, 9)       /* SD1_DAT5 */

#define MX6SL_NFC_INT		IMX_GPIO_NR(3, 30)
#define MX6SL_NFC_VEN		IMX_GPIO_NR(4, 26)
#define ACEP13_NFC_DR		IMX_GPIO_NR(2, 5)
#define ACEP13_NFC_INT		IMX_GPIO_NR(2, 6)
#define ACEP13_NFC_VEN		IMX_GPIO_NR(1, 28)
#define ACEP13_LED1 		IMX_GPIO_NR(1, 11)
#define ACEP13_LED2 		IMX_GPIO_NR(1, 12)
#define ACEP13_LED3 		IMX_GPIO_NR(1, 13)
#define ACEP13_LED4 		IMX_GPIO_NR(1, 14)
#define ACEP13_SLED1 		IMX_GPIO_NR(1, 24)
#define ACEP13_SLED2 		IMX_GPIO_NR(1, 25)
#define ACEP13_LEDCTRL 		IMX_GPIO_NR(4, 0)

#define MX6SL_TK_INT		IMX_GPIO_NR(4, 14)
...
static iomux_v3_cfg_t mx6sl_ntx_lcd_spi1_pads[] = {
	MX6SL_PAD_LCD_DAT0__ECSPI1_MOSI,
	MX6SL_PAD_LCD_DAT1__ECSPI1_MISO,
	MX6SL_PAD_LCD_DAT3__ECSPI1_SCLK,
	MX6SL_PAD_LCD_DAT2__ECSPI1_SS0,
};
...
static iomux_v3_cfg_t mx6sl_ntx_spi2_spi2_pads[] = {
...
static iomux_v3_cfg_t mx6sl_ntx_uart4_pads[] = {
...
static iomux_v3_cfg_t mx6sl_ntx_amp_gpio_pads[] = {
	MX6SL_PAD_KEY_COL0__GPIO_3_24,
	MX6SL_PAD_KEY_COL3__GPIO_3_30,
};

static iomux_v3_cfg_t mx6sl_ntx_acep13_pads[] = {
	...
	MX6SL_PAD_EPDC_GDCLK__GPIO_1_31_KEY,
	MX6SL_PAD_EPDC_GDSP__GPIO_2_2_KEY,
	MX6SL_PAD_EPDC_GDRL__GPIO_2_1_KEY,
	MX6SL_PAD_EPDC_GDOE__GPIO_2_0_KEY,
	MX6SL_PAD_EPDC_BDR0__GPIO_2_5,
	MX6SL_PAD_EPDC_BDR1__GPIO_2_6,
	MX6SL_PAD_EPDC_SDCE1__GPIO_1_28,
	MX6SL_PAD_EPDC_SDCE0__PWM3_PWMO,
	MX6SL_PAD_SD1_DAT6__GPIO_5_7_KEY,
	MX6SL_PAD_EPDC_SDCLK__GPIO_1_23_KEY,
	MX6SL_PAD_EPDC_SDSHR__GPIO_1_26_KEY,
