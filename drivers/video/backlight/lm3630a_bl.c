...
static int _fl_lm3630a_percentage (struct lm3630a_chip *pchip,int iFL_Percentage)
{
	...
	if (0 == iFL_Percentage) {
		...
		/*
		changeset:   1419:792d2180e422
		parent:      1416:b9d96c4b2c39
		user:        skillig
		date:        Fri Jun 17 11:54:25 2016 +0200
		summary:     82166 fixed step when fading out
		*/
		// but seems to be unneccessary (I can't see the error anymore), at least on the epos.
		// _lm3630a_set_FL (pchip ,4, 0, 7, 0);
	}
			 ...
			 const struct i2c_device_id *id)
{
	...
	if(40==gptHWCFG->m_val.bPCB||50==gptHWCFG->m_val.bPCB||70==gptHWCFG->m_val.bPCB) {
		// https://tools.pageplace.de/redmine/issues/82166#note-9
		pchip->bOnOffRamp = 1<<3 | 2;
