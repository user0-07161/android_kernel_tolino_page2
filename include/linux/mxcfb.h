...
#define WAVEFORM_MODE_A2                        0x4   // animation
#define WAVEFORM_MODE_GL16                      0x5   //
#define WAVEFORM_MODE_GLR16                     0x6   //
#define WAVEFORM_MODE_GLD16                     0x7   // High fidelity non-flashing
...
#define EPDC_FLAG_DEBUG_BUFFER          0x10000
#define EPDC_FLAG_ENABLE_FRAMEEND_INT          0x20000
...
#define MXCFB_SEND_UPDATE_ORG		_IOW('F', 0x2E, struct mxcfb_update_data_org)
	...
	#define MXCFB_WAIT_FOR_UPDATE_COMPLETE _IOWR('F', 0x2F, struct mxcfb_update_marker_data)
#endif//] CONFIG_MACH_MX6SL_NTX
#define MXCFB_WAIT_FOR_UPDATE_COMPLETE2 _IOWR('F', 0x35, struct mxcfb_update_marker_data) // ICS version for mx6sl/mx6dl . 
