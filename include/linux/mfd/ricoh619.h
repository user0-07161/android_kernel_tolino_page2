...
#define INT_WDOG_ENABLE		1
#define INT_PWRON_OFF_ENABLE		1
//#define WDOG_DISABLE_1ST_INT	1

#if defined(INT_WDOG_ENABLE) && !defined(WDOG_DISABLE_1ST_INT) //[
#define WDOG_DISABLE_IN_SUSPEND		1
#endif //]
