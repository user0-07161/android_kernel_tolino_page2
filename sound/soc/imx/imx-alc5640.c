				     ...
				     struct snd_pcm_hw_params *params)
{
	...
	switch(sample_rate)
	{
		...
		case 96000:
		case 192000:
			clk_set_rate(pll4, 196608000);
			div_pm = 196608000/1024/sample_rate;
		break;
		case 11025:
		case 22050:
		case 44100:
		case 88200:
		case 176400:
			clk_set_rate(pll4, 180633600);
			div_pm = 180633600/1024/sample_rate;
		break;		
		default:
		break;
	}
	...
	if(channels == 1)
	{
		ret = snd_soc_dai_set_pll(codec_dai, RT5640_PLL1_S_BCLK1,
					RT5640_PLL1_S_BCLK1, sample_rate*32, pll_out);
	}
	else
	{
		ret = snd_soc_dai_set_pll(codec_dai, RT5640_PLL1_S_BCLK1,
	...
	//IMX_SSI_TX_DIV_PSR not work , always 1
