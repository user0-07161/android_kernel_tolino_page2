...
extern int mx6_ntx_audio_amp_enable(int enable);
		...
		struct snd_soc_dai *dai)
{
	...
	case SNDRV_PCM_TRIGGER_PAUSE_RELEASE:
		...
		if (++ssi->enabled == 1)
			scr |= SSI_SCR_SSIEN;
#if defined(CONFIG_MACH_MX6Q_NTX) || defined(CONFIG_MACH_MX6SL_NTX)//[
		mx6_ntx_audio_amp_enable (1);
#endif//]CONFIG_MACH_MX6Q_NTX || CONFIG_MACH_MX6SL_NTX
		break;
